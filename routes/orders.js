...
// const OrderItem = require("../models/orders_items");
    ...
    .then((data) => {
      if (data) {
        ...
        const newAddress = {
          ...
          street: addressDelivery?.addressStreet || "",
        ...
        const newOrder = new Order({
          ...
          addressDelivery:
            newAddress /*[id, street, zipCode, city, state, country, phoneNumber, isForBilling, isForDelivery, isDefault, isDeleted,]*/,
